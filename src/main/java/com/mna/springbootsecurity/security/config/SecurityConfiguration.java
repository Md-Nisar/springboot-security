...
import com.mna.springbootsecurity.security.filter.JwtAuthorizationFilter;
import com.mna.springbootsecurity.security.filter.JwtBlacklistFilter;
import com.mna.springbootsecurity.security.filter.XSSFilter;
        ...
        http
                ...
                .headers(headers -> {
                    ...
                    if (!applicationProperties.isLocalEnvironment()) {
                        ...
                        .requestMatchers("/api/v1/user/**").hasAnyRole(Roles.USER.name(), Roles.ADMIN.name())
                ...
                .addFilterBefore(xssFilter, JwtBlacklistFilter.class)
